  ...
  return (
    <div className="py-4">
      <Card className="border-none shadow-none">
        <CardHeader>
          <CardTitle className="text-xl text-primary">Savings & Investment Calculator</CardTitle>
          <CardDescription>
            Project returns from savings accounts, fixed deposits, and investment products.
